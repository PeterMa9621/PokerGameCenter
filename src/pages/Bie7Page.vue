                ...
                <v-stage ref="stage" :config="configCanvas">
                    ...
                    <v-layer>
                        ...
                        <OperationPanel :x="center.x" :card-height="cardHeight" :pokers="pokers" @showTipArea="(msg) => showTipArea(msg)"
                                        ...
                                        :covered-pokers="myCoveredPokers" :service="service" />
...
<script>
    ...
    export default {
        name: "BieSevenPage",
        components: {Bie7CoverPokerArea, TipTextArea, OperationPanel, Bie7SideBar, Bie7UserInfo, MyPoker, PokerCard},
        data() {
            return {
                configCanvas: {
                    width: width,
        ...
        mounted() {
            ...
            this.service.joinCallback = (orderedPlayers, players) => {
                this.players = players;
                this.opponents = Object.assign({}, orderedPlayers);
                this.opponents = Utility.removePlayerByUserName(this.opponents, userName);
                this.me = {
                    ...players[userName],
                    myPokers: []
                };
            ...
            this.service.startCallback = (myPokers) => {
                  this.me.myPokers = PokerUtility.convertPokers(myPokers);
